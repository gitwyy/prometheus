...
public class MysqlDataSource {
    ...
    public static final String MAPPER_LOCATION = "classpath:com/pay/aphrodite/core/mapper/mysql/*.xml";
    public static final String PACKAGE = "com.pay.aphrodite.core.dao.mysql";
